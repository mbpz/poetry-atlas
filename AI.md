...
| 方案 | 说明 |
| ---- | ---- |
| **CosyVoice**（阿里） | 中文效果好、支持情感 |
| **Edge TTS**（微软） | 免费、质量稳定 |
| **Fish Speech / ChatTTS** | 开源、可本地部署 |
...
| 场景 | 模型 | 说明 |
| ---- | ---- | ---- |
| 古诗配图 | Stable Diffusion / Flux | 根据诗意生成水墨画 |
| 历史场景复原 | 图像修复 + ControlNet | 基于古画复原 |
| 旅行路线图 | 地图渲染 + 标注 | 自动生成分享图 |
| 数字人讲解 | HeyGen / 本地数字人 | 虚拟教师 |
...
| 场景 | 首选模型 | 备选 | 理由 |
| ---- | -------- | ---- | ---- |
| 诗词解析 | DeepSeek V3 | Qwen-Max | 中文理解强 |
| 地点故事 | Claude Sonnet | GPT-4o | 文采好 |
| 旅行规划 | Claude Sonnet | DeepSeek | 推理强 |
| 对话导游 | Qwen-Plus | DeepSeek | 性价比 |
| 数据抽取 | DeepSeek | Qwen | 准确率高 |
| 视觉生成 | Flux / SD3 | DALL·E | 图像质量 |
